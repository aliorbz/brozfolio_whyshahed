  ...
  return (
    <footer className="py-8 space-y-4 scroll-reveal">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        <div className="lg:col-span-6 bento-card p-8 sm:p-16 flex flex-col justify-between min-h-[350px] !bg-[#f9f5f2]">
          ...
          <div className="flex items-center gap-2 sm:gap-4 group cursor-pointer w-fit max-w-full">
            <a 
              href="mailto:whyshahed@gmail.com"
        ...
        <div className="lg:col-span-6 bg-[#ff4e46] rounded-[2.5rem] sm:rounded-[3rem] p-10 sm:p-16 flex flex-col items-center justify-center relative overflow-hidden min-h-[400px]">
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 max-w-xl relative z-10">
            {[
              { text: 'FOLLOW ME!', classes: 'bg-black text-white border border-black rotate-[2deg]', url: 'https://x.com/whyshahed' },
              { text: 'INSTAGRAM', classes: 'bg-white text-black rotate-[-6deg]', url: 'https://www.instagram.com/whyshaheed' },
              { text: 'COMMUNITY', classes: 'bg-black text-white rotate-[4deg]', url: 'https://alphabrozdao.vercel.app/' },
              { text: 'TELEGRAM', classes: 'bg-white text-black rotate-[-3deg]', url: 'https://t.me/whyshahed' },
              { text: 'LINKEDIN', classes: 'bg-black text-white rotate-[8deg]', url: 'https://bd.linkedin.com/in/shahed-choudhury-683b95278/' },
              { text: 'DISCORD', classes: 'bg-white text-black rotate-[-2deg]', url: 'https://discord.com/users/942841769572331550' },
            ].map((bubble, i) => {
