  ...
  return (
    <section className="py-8 sm:py-12 scroll-reveal">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        <div className="lg:col-span-5 bento-card p-10 sm:p-14 lg:p-16 flex flex-col justify-between !bg-[#f9f5f2]">
        ...
        <div className="lg:col-span-7 flex flex-col gap-4">
          {experiences.map((exp, idx) => (
            <div key={idx} className="bento-card p-7 sm:p-9 flex items-center gap-6 group transition-all flex-1 !bg-[#f9f5f2]">
